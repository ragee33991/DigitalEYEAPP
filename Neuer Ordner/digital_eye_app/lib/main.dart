...
import 'Screens/OnBoarding/OnBoardingDoctors.dart';
import 'Screens/OnBoarding/OnBoardingMedicine.dart';
import 'Screens/TabBarScreens/DoctorList/DoctorList.dart';
import 'Screens/TabBarScreens/DoctorList/camera_preview_scanner.dart';
import 'Screens/TabBarScreens/DoctorList/material_barcode_scanner.dart';
import 'Screens/TabBarScreens/DoctorList/picture_scanner.dart';
...
class _HomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
        ...
        routes: {
         ...
         RouterName.CREATE_ACCOUNT_WEIGHT: (context) =>
              CreateAccountWeightPage.ProviderPage(),
  ...
  Future<void> _showNotification() async {
    ...
    await flutterLocalNotificationsPlugin.show(
        0, 'Questionnaire', 'Your next Questionnaire awaits!', platformChannelSpecifics,
        payload: 'item x');
  }
}
