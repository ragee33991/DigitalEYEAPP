...
import 'package:digital_eye_app/Screens/CartList/CartList.dart';
    ...
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder:
        ...
        if (snapshot.connectionState == ConnectionState.done) {
          ...
          return setAppointmentListView(index,context,data['name'].toString());
        }
...
setAppointmentListView(int index,BuildContext context, String s){
  return new InkWell(
    onTap: (){
...
setCommonCartNitificationView(BuildContext context){
  //the birthday's date
  if(RouterName.DateOfQuiz!=null) {
    final birthday = DateTime.parse(RouterName.DateOfQuiz.toString());
    print(birthday.day);
    ...
    print("The dates are" +difference.toString() + "apart");
  }
  return <Widget>[
            new Container(
              height: 20,
            ...
            new Container(
              ...
              child: new InkWell(
                        onTap: (){
                          Navigator.of(context).push(MaterialPageRoute(builder: (context)=>NotificationsScreen(value: value,result:result)));
                        },
                        child: new Stack(
                        alignment: Alignment.center,
                        children: <Widget>[
