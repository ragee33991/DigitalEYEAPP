...
class myDailyNotifications extends StatefulWidget {
  @override
  _myDailyNotifications createState() => _myDailyNotifications();
}

class _myDailyNotifications extends State<myDailyNotifications> {
  @override
  void initState() {
    super.initState();
...
//  'Repeat notification every day at approximately 10:00:00 am',
  ...
  weeklynotification() async {
    ...
    return notifications.showWeeklyAtDayAndTime(
      Day.monday,
      Time(10, 0, 0),
      id: 0,
      title: 'show weekly title',
  ...
  //picture
  IosAttachmentnotification() async {
