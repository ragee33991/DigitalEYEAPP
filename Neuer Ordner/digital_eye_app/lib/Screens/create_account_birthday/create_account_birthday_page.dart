                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: CupertinoPicker(
                              ...
                              backgroundColor: Colors.transparent,
                              diameterRatio: 20.0,
                              children: CreateAccountBirthdayPage.of(context)
                                  .lstDay
                                  .map((d) {

                                return _ItemPicker(d.toString().padLeft(2, '0'),
                                    selected: d ==
                                        CreateAccountBirthdayPage.of(context)
                                            .daySelected);
                              }).toList(),
              ...
              Container(
                ...
                child: button(
                    ...
                    onPressed: () {
                      ...
                      RouterName.dob = CreateAccountBirthdayPage.of(context)
                          .yearSelected.toString() + "-" + CreateAccountBirthdayPage.of(context)
                          .monthSelected.toString()+ "-" +CreateAccountBirthdayPage.of(context)
