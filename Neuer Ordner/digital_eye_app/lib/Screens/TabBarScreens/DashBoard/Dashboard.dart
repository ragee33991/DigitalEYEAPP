...
import 'package:digital_eye_app/Notifications/notification_bloc.dart';
...
import 'package:digital_eye_app/Screens/DrugListScreen/DrugListScreen.dart';
...
import 'package:digital_eye_app/Screens/ImportantNoteScreen/ImportantNoteScreen.dart';
...
AppTranslationsDelegate _newLocaleDelegate;
  ...
  _performActionOnNotification(Map<String, dynamic> message) async {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => FindDoctorScreen(widget.firebaseId),
      ),
    );
  }
