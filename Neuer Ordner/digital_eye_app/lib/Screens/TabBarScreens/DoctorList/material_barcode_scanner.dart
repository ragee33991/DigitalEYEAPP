...
class MaterialBarcodeScanner extends StatefulWidget {
  ...
  const MaterialBarcodeScanner({
    this.validRectangle = const Rectangle(width: 450, height: 144),
      ...
      ScannerUtils.detect(
        ...
        imageRotation: sensorOrientation,
          ...
          _handleResult(
            barcodes: result,
            data: data,
            imageSize: Size(image.width.toDouble()/2, image.height.toDouble()/2),
          );
        },
                      ...
                      Container(
                        child: SafeArea(
                         child: Column(children: <Widget>[
                           file2 == null ? Image.asset("images/place-holder.png") :
                          Image.file(File(file2))
