...
class TestIndicatorDetails extends StatefulWidget {
  ...
  TestIndicatorDetails(this.monVal, this.tueVal, this.WedVal, this.ThurVal, this.FriVal, this.SatVal, this.SunVal,
      this.total, this.today, this.minDate, this.minAmount, this.maxDate, this.maxAmount,this.title,this.OverallData);
