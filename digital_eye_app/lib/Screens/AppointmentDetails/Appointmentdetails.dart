...
class AppointmentDetails extends StatefulWidget {
  ...
  const AppointmentDetails({Key key, this.time, this.date}) : super(key: key);
      ...
      children: <Widget>[
        ...
        new Container(
          ...
          child: new Material(
            ...
            child: new Padding(
              padding: new EdgeInsets.only(left: 15,right: 15),
              child: _setDetailCommonView(widget.date.toString(),Icons.calendar_today)
            ),
          ),
        ),
        SizedBox(height: 30,),
        new Container(
          ...
          child: new Material(
            ...
            child: new Padding(
              padding: new EdgeInsets.only(left: 15,right: 15),
              child: _setDetailCommonView(widget.time.toString(),Icons.watch_later)
            ),
          ),
        ),
        SizedBox(height: 35,),
