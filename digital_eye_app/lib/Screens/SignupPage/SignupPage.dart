      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          new InkWell(
            ...
            child: new Container(
              ...
              child: new Material(
                ...
                child: new Center(
                  child: new Text(
                    AppTranslations.of(context).text(AppTitle.loginSignUp),
          ...
          new Row(
            ...
            children: <Widget>[
              new Text(
                AppTranslations.of(context).text(AppTitle.signUpNote),
                textDirection: SharedManager.shared.direction,
                style: new TextStyle(
                    color: Colors.grey,
                    fontSize: 16,
              ...
              InkWell(
                child: new Text(
                  AppTranslations.of(context).text(AppTitle.loginSignIn),
                  textDirection: SharedManager.shared.direction,
                  style: new TextStyle(
                      color: AppColor.themeColor,
                      fontSize: 14,
