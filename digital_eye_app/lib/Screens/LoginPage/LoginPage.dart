...
class _LoginPageState extends State<LoginPage> {
      ...
      child: isLoading
          ...
          : new Column(
              ...
              children: <Widget>[
                ...
                setTextFiels1(
                  AppTranslations.of(context).text("loginUserName"),
                  Icons.person,
                  userName,
                ),
                SizedBox(
                ...
                new InkWell(
                      ...
                      showDialog(
                        ...
                        builder: (context) {
                          return CustomDialogOne(
                            ...
                            content:
                                "If you dont have a Username then please click on the Sign Up link.",
                  ...
                  child: new Container(
                    ...
                    child: new Material(
                      ...
                      child: new Center(
                        child: new Text(
                          AppTranslations.of(context).text("loginSignIn"),
                          style: new TextStyle(
                              color: Colors.white,
                              fontSize: 16,
                              fontWeight: FontWeight.w500),
                ...
                new Row(
                  ...
                  children: <Widget>[
                    new Text(
                      AppTranslations.of(context).text("loginDontHaveAccount"),
                      textDirection: SharedManager.shared.direction,
                      style: new TextStyle(
                          color: Colors.grey,
                          fontSize: 16,
    ...
    if (userName.text != null && userName.text != null) {
      try {
        ...
        UserCredential result = await auth.signInWithEmailAndPassword(
            email: userName.text + "@gmail.com", password: userName.text);
        ...
        print(value);
        if (value == true) {
          databaseService.addSavedUsername(userName.text);
        }
        if (value == false) {
          databaseService.removedSavedUsername();
        }
  ...
  void getMyUsername() async {
    final text = await databaseService.getSavedUsername();
    print(text);
    if (text.isNotEmpty) {
      value = true;
      userName.text = text;
